...
if __name__ == "__main__":
	...
	filelist = "filelist_QCD_HT_1500to2000_2017_Dec2018.txt"
	inputjson = 'Cert_294927-306462_13TeV_PromptReco_Collisions17_JSON.txt'
        outputjson = 'json/qcdmc2017.json'
	PicoTreeTest = picoTree("trees/2017/QCD_HT_1500to2000/tree_QCD_HT_1500to2000",filelist, 0.1215/11703477., triggers, jess, jers, True,inputjson,outputjson)
