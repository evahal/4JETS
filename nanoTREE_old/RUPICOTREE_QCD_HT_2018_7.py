...
if __name__ == "__main__":
	...
	filelist = "filelist_QCD_HT_2000toInf_2018_Dec2018.txt"
	inputjson = 'Cert_314472-325175_13TeV_PromptReco_Collisions18_JSON.txt'
        outputjson = 'json/qcdmc2018.json'
	PicoTreeTest = picoTree("trees/2018/QCD_HT_2000toInf/tree_QCD_HT_2000toInf",filelist, 0.02542/5596831., triggers, jess, jers, True,inputjson,outputjson)
