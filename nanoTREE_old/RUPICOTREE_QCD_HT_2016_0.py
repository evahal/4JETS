...
if __name__ == "__main__":
	...
	filelist = "filelist_QCD_HT_100to200_2016_Dec2018.txt"
	inputjson = 'Cert_271036-284044_13TeV_PromptReco_Collisions16_JSON.txt'
        outputjson = 'json/qcdmc2016.json'
	PicoTreeTest = picoTree("trees/2016/QCD_HT_100to200/tree_QCD_HT_100to200",filelist, 27990./82293477., triggers, jess, jers, True,inputjson,outputjson)
