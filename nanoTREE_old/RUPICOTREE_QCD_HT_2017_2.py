...
if __name__ == "__main__":
	...
	filelist = "filelist_QCD_HT_300to500_2017_Dec2018.txt"
	inputjson = 'Cert_294927-306462_13TeV_PromptReco_Collisions17_JSON.txt'
        outputjson = 'json/qcdmc2017.json'
	PicoTreeTest = picoTree("trees/2017/QCD_HT_300to500/tree_QCD_HT_300to500",filelist, 366.8/61630261., triggers, jess, jers, True,inputjson,outputjson)
