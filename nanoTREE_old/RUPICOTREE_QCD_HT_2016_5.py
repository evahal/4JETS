...
if __name__ == "__main__":
	...
	filelist = "filelist_QCD_HT_1000to1500_2016_Dec2018.txt"
	inputjson = 'Cert_271036-284044_13TeV_PromptReco_Collisions16_JSON.txt'
        outputjson = 'json/qcdmc2016.json'
	PicoTreeTest = picoTree("trees/2016/QCD_HT_1000to1500/tree_QCD_HT_1000to1500", filelist, 1.064/(5094856.+10362113.), triggers, jess, jers, True, inputjson,outputjson)
