...
if __name__ == "__main__":
	...
	filelist = "filelist_QCD_HT_300to500_2016_Dec2018.txt"
	inputjson = 'Cert_271036-284044_13TeV_PromptReco_Collisions16_JSON.txt'
        outputjson = 'json/qcdmc2016.json'
	PicoTreeTest = picoTree("trees/2016/QCD_HT_300to500/tree_QCD_HT_300to500", filelist, 366.8/(17037403.+37988434.), triggers, jess, jers, True,inputjson,outputjson)
