...
if __name__ == "__main__":
	...
	jers = {"JER": PREPJERU("fromMarc/Summer16_25nsV1_MC_SF_AK4PFPuppi.txt")}
        filelist = "filelist_JetHT_Run2016H2_Feb2018.txt"
#	inputjson = 'Cert_271036-284044_13TeV_PromptReco_Collisions16_JSON.txt'
	inputjson = 'Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON_Alejandro.txt'
        outputjson = 'json/data_Run2016H2.json'
	PicoTreeTest = picoTree("trees/2016/data_JetHT_Run2016H2/tree_data_JetHT_Run2016H2",filelist, 1.0, triggers, jess, jers, False, inputjson,outputjson)
