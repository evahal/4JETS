...
if __name__ == "__main__":
	...
	filelist = "filelist_QCD_HT_200to300_2017_Dec2018.txt"
	inputjson = 'Cert_294927-306462_13TeV_PromptReco_Collisions17_JSON.txt'
        outputjson = 'json/qcdmc2017.json'
	PicoTreeTest = picoTree("trees/2017/QCD_HT_200to300/tree_QCD_HT_200to300",filelist, 1735./59474148., triggers, jess, jers, True,inputjson,outputjson)
