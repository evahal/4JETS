...
if __name__ == "__main__":
	...
	filelist = "filelist_QCD_HT_2000toInf_2016_Dec2018.txt"
	inputjson = 'Cert_271036-284044_13TeV_PromptReco_Collisions16_JSON.txt'
        outputjson = 'json/qcdmc2016.json'
	PicoTreeTest = picoTree("trees/2016/QCD_HT_2000toInf/tree_QCD_HT_2000toInf", filelist, 0.02542/(1992472.+4048338.), triggers, jess, jers, True, inputjson,outputjson)
