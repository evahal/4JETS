...
if __name__ == "__main__":
	...
	filelist = "filelist_QCD_HT_500to700_2017_Dec2018.txt"
	inputjson = 'Cert_294927-306462_13TeV_PromptReco_Collisions17_JSON.txt'
        outputjson = 'json/qcdmc2017.json'
	PicoTreeTest = picoTree("trees/2017/QCD_HT_500to700/tree_QCD_HT_500to700",filelist, 29.37/57415491., triggers, jess, jers, True,inputjson,outputjson)
