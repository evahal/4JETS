...
if __name__ == "__main__":
	...
	filelist = "filelist_QCD_HT_700to1000_2016_Dec2018.txt"
	inputjson = 'Cert_271036-284044_13TeV_PromptReco_Collisions16_JSON.txt'
        outputjson = 'json/qcdmc2016.json'
	PicoTreeTest = picoTree("trees/2016/QCD_HT_700to1000/tree_QCD_HT_700to1000", filelist, 6.524/(15633337.+29864750.), triggers, jess, jers, True, inputjson,outputjson)
