...
if __name__ == "__main__":
	...
	filelist = "filelist_JetHT_Run2017B_Dec2018.txt"
	inputjson = 'Cert_294927-306462_13TeV_PromptReco_Collisions17_JSON.txt'
        outputjson = 'json/data_Run2017B.json'
	PicoTreeTest = picoTree("trees/2017/data_JetHT_Run2017B/tree_data_JetHT_Run2017B", filelist, 1.0, triggers, jess, jers, False, inputjson,outputjson)
