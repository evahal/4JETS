...
if __name__ == "__main__":
	...
	filelist = "filelist_QCD_HT_2000toInf_2017_Dec2018.txt"
	inputjson = 'Cert_294927-306462_13TeV_PromptReco_Collisions17_JSON.txt'
        outputjson = 'json/qcdmc2017.json'
	PicoTreeTest = picoTree("trees/2017/QCD_HT_2000toInf/tree_QCD_HT_2000toInf",filelist, 0.02542/5941306., triggers, jess, jers, True,inputjson,outputjson)
