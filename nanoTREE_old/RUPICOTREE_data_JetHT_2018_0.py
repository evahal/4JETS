...
if __name__ == "__main__":
	...
	filelist = "filelist_JetHT_Run2018A_Dec2018.txt"
	inputjson = 'Cert_314472-325175_13TeV_PromptReco_Collisions18_JSON.txt'
        outputjson = 'json/data_Run2018A.json'
	PicoTreeTest = picoTree("trees/2018/data_JetHT_Run2018A/tree_data_JetHT_Run2018A", filelist, 1.0, triggers, jess, jers, False, inputjson,outputjson)
