...
if __name__ == "__main__":
	...
	filelist = "filelist_QCD_HT_700to1000_2018_Dec2018.txt"
	inputjson = 'Cert_314472-325175_13TeV_PromptReco_Collisions18_JSON.txt'
        outputjson = 'json/qcdmc2018.json'
	PicoTreeTest = picoTree("trees/2018/QCD_HT_700to1000/tree_QCD_HT_700to1000",filelist, 6.524/48250980., triggers, jess, jers, True,inputjson,outputjson)
