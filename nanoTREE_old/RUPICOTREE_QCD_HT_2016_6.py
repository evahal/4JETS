...
if __name__ == "__main__":
	...
	filelist = "filelist_QCD_HT_1500to2000_2016_Dec2018.txt"
	inputjson = 'Cert_271036-284044_13TeV_PromptReco_Collisions16_JSON.txt'
        outputjson = 'json/qcdmc2016.json'
	PicoTreeTest = picoTree("trees/2016/QCD_HT_1500to2000/tree_QCD_HT_1500to2000", filelist, 0.1215/(3946009.+7868538.), triggers, jess, jers, True, inputjson,outputjson)
