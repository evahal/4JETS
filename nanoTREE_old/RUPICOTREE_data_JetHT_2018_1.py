...
if __name__ == "__main__":
	...
	filelist = "filelist_JetHT_Run2018B_Dec2018.txt"
	inputjson = 'Cert_314472-325175_13TeV_PromptReco_Collisions18_JSON.txt'
        outputjson = 'json/data_Run2018B.json'
	PicoTreeTest = picoTree("trees/2018/data_JetHT_Run2018B/tree_data_JetHT_Run2018B", filelist, 1.0, triggers, jess, jers, False, inputjson,outputjson)
